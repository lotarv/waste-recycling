...
function TechnologyForm() {
    ...
    const handleNestedChange = (index, key, field, value) => {
            ...
            <form onSubmit={handleSubmit} className="technology-form">
                    ...
                    {formData.secondaryWasteOkpd.map((item, index) => (
                        <div key={index} className="nested-group">
                            <input
                                ...
                                value={item.okpdCode}
                                onChange={(e) =>
                                    handleNestedChange(index, "secondaryWasteOkpd", "okpdCode", e.target.value)
                                }
                            />
                            <input
                                type="text"
                                ...
                                value={item.okpdName}
                                onChange={(e) =>
                                    handleNestedChange(index, "secondaryWasteOkpd", "okpdName", e.target.value)
                                }
                            />
                ...
                <div className="form-group">
                    ...
                    {formData.secondaryWaste.map((item, index) => (
                        <div key={index} className="nested-group">
                            ...
                            <input
                                ...
                                value={item.mass}
                                onChange={(e) =>
                                    handleNestedChange(index, "secondaryWaste", "mass", e.target.value)
                                }
                            />
                            ...
                            <input
                                ...
                                value={item.volume}
                                onChange={(e) =>
                                    handleNestedChange(index, "secondaryWaste", "volume", e.target.value)
                                }
                            />
                            ...
                            <button
                                type="button"
                                onClick={() => removeElement("secondaryWaste", index)}
                            >
                                Удалить
                            </button>
                        </div>
                    ...
                    <button
                        type="button"
                        onClick={() =>
                            addElement("secondaryWaste", { mass: "", volume: "", fkkoID: "" })
                        }
                    >
