...
const TechDetails = () => {
    ...
    /*
    const api_url = `http://localhost:8080/technology?id=${id}`;
    ...
    */
    ...
    return (
        <div className="tech-details">
            ...
            <p>
                <strong>Наименование технологии:</strong> {data.name}
            </p>
            <p>
                <strong>Назначение технологии:</strong> {data.assignment}
            </p>
            <p>
                <strong>Краткая характеристика технологического процесса:</strong>{" "}
                {data.characteristic}
            </p>
            <p>
                <strong>Потребляемые ресурсы:</strong>
            </p>
            <Table columns={columnsResources} data={[data.resources]} />
            <p>
                <strong>Наименование и код по ФККО используемых отходов:</strong>
            </p>
            <Table columns={fkkoColumns} data={data.fkko} />
            <p>
                <strong>Наименование и код по ОКПД получаемой продукции:</strong>
            </p>
            <Table columns={okpdColumns} data={data.okpd} />
            <p>
                <strong>Производительность при получении продукции (тонн/год):</strong>{" "}
                {data.performance}
            </p>
            <p>
                <strong>Масса, объем, наименование и код по ФККО вторичных отходов:</strong>
            </p>
            <Table columns={secondaryWasteColumns} data={secondaryWasteDataModified} />
            <p>
                <strong>Информация о разработчике технологии:</strong>
            </p>
            <Table columns={developerColumns} data={[data.developer]} />
            <p>
                <strong>Информация о юридических лицах, применяющих технологию:</strong>
            </p>
            <Table columns={userColumns} data={data.users} />
            <p>
                <strong>Применение технологии:</strong> {data.useCase}
            </p>
            <p>
                <strong>Экспертная информация:</strong>
            </p>
            <p>
                {data.expertInfo.name}, {data.expertInfo.date}, {data.expertInfo.conclusion}
            </p>
        </div>
    );
};
